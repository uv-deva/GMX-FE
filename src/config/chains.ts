...
export const DEPO = 51181;

// TODO take it from web3
export const DEFAULT_CHAIN_ID = DEPO;
export const CHAIN_ID = DEFAULT_CHAIN_ID;

export const SUPPORTED_CHAIN_IDS = [DEPO, ARBITRUM, AVALANCHE];
...
const constants = {
  ...
  [DEPO]: {
    nativeTokenSymbol: "tDEPO",
    wrappedTokenSymbol: "DEPO",
    defaultCollateralSymbol: "USDC",
    defaultFlagOrdersEnabled: true,
    positionReaderPropsLength: 9,
    v2: true,
...
export const RPC_PROVIDERS = {
  ...
  [DEPO]: ["https://test1rpc.depo.network"],
};
...
export const NETWORK_METADATA: { [chainId: number]: NetworkMetadata } = {
  ...
  [DEPO]: {
    chainId: "0x" + DEPO.toString(16),
    chainName: "Depo Testnet",
    nativeCurrency: {
      name: "tDepo",
      symbol: "tDepo",
      decimals: 18,
    },
    rpcUrls: RPC_PROVIDERS[DEPO],
    blockExplorerUrls: [getExplorerUrl(DEPO)],
  },
};
...
export function getExplorerUrl(chainId) {
  ...
  } else if (chainId === DEPO) {
    return "https://test1exp.depo.network/";
  }
