...
import logoImg from "img/Alto-Icon.svg";
import logoSmallImg from "img/Alto-Icon.svg";
        ...
        {!isMobile && (
          <div className="App-header large">
            <div className="App-header-container-left">
              <Link className="App-header-link-main size-[60px]" to="/">
                {/* <img src={logoImg} className="big" alt="Alto GMX Logo" />
                <img src={logoSmallImg} className="small" alt="Alto GMX Logo" /> */}
                <AltoSvgLogo />
              </Link>
              {isHomeSite() ? (
